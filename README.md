...
![Notch Police on the right screen edge: five remaining-quota rings, the Claude ring at 12% with its hover card open showing the 5-hour and weekly windows, the pace estimate, and the two handover buttons](docs/preview.png)
